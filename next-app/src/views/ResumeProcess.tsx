...
export default function ResumeProcess() {
  ...
  return (
    <div className="min-h-[calc(100vh-77px)] bg-[linear-gradient(180deg,_#f8fbff_0%,_#eef4ff_22%,_#fff8ef_100%)]">
        ...
        <section className="relative pl-0 lg:pl-28">
          ...
          <div className="grid gap-8">
            {resumeProcessSteps.map((item, index) => (
              <ScrollReveal key={item.id} className="relative" delay={index * 70}>
                <article className="relative rounded-[34px] border border-slate-200 bg-white shadow-[0_26px_80px_-48px_rgba(15,23,42,0.35)]">
